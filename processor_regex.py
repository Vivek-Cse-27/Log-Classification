...
if __name__ == '__main__':
    ...
    print(classify_with_regex("System updated to version 31.08.2002"))
    ...
    print(classify_with_regex("Account with ID 201011 created by user1."))
    print(classify_with_regex("What's going on here !!!!"))